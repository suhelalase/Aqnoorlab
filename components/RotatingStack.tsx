  ...
  return (
    <div className="wrap_card">
      ...
      <div className="rotating-card">
        <div className="wrap_card_content flex flex-col items-center justify-center">
          <span className="font-display">Web</span>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height={48}
            width={48}
            className="wrap_card_svg"
      ...
      <div className="rotating-card">
        <div className="wrap_card_content flex flex-col items-center justify-center">
          <span className="font-display">AI</span>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height={48}
      ...
      <div className="rotating_lines">
        <div className="rotating_line" />
        <div className="rotating_line" />
      </div>
    </div>
  );
